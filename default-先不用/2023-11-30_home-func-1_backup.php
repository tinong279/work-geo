<?php
    ...
    function home_get_inclinometer_all()
    {
    	...
    	home_get_inclinometer_with_offset("2.1K 傾斜儀(左)", 1, $id_1_ad1_offset, $id_1_ad2_offset);
		
    	home_get_inclinometer_with_offset("2.1K 傾斜儀(右)", 2, $id_2_ad1_offset, $id_2_ad2_offset);
		// 2023-10-04
