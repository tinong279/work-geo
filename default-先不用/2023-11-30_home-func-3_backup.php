<?php
    ...
    function home_get_inclinometer_all()
    {
    	...
    	home_get_inclinometer_with_offset("23.1K 傾斜儀(左)", 21, $id_21_ad1_offset, $id_21_ad2_offset);
    	home_get_inclinometer_with_offset("23.1K 傾斜儀(右)", 22, $id_22_ad1_offset, $id_22_ad2_offset);
    }
    function home_get_raingauge_all()
    {
        require("C:\\xampp\\htdocs\\default\\lora-offset.php");
    	home_get_raingauge_with_offset("23.1K 雨量筒", 29, $id_29_count_offset);
    }
