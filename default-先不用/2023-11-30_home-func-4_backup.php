<?php
    ...
    function home_get_inclinometer_all()
    {
    	...
    	home_get_inclinometer_with_offset("28.5K 傾斜儀(左)", 31, $id_31_ad1_offset, $id_31_ad2_offset);
    	home_get_inclinometer_with_offset("28.5K 傾斜儀(右)", 32, $id_32_ad1_offset, $id_32_ad2_offset);
    }
    function home_get_raingauge_all()
    {
        require("C:\\xampp\\htdocs\\default\\lora-offset.php");
    	home_get_raingauge_with_offset("28.5K 雨量筒", 39, $id_39_count_offset);
    }
