...
<script type="text/javascript">
    ...
    function Marker_onClick(obj_id)
    {
		...
		<div class="w3-card-4" style="margin-top:20px;width:100%;">
			...
			<div class="w3-container w3-border-left w3-border-right w3-border-bottom" >
                <div class="w3-half" style="">
					<!--
                    <img style="width:100%;object-fit:fill;margin-top:14px;" src="live/1-1.jpg<?php echo '?t=' . rand() ?>" loading="lazy"></img>
					-->
					<a href="/manager-page/api/live.php?id=11" target="_blank">
					<img loading="lazy" style="width:100%;object-fit:fill;margin-top:14px;" data-src="/manager-page/api/snapshot.php?id=11" src="/manager-page/api/snapshot.php?id=11" onerror="this.src='live/1-1.jpg';" class="video_obj" />
					</a>
				</div>
                <div class="w3-half" style="">
					<!--
                    <img style="width:100%;object-fit:fill;margin-top:14px;margin-bottom:14px;" src="live/1-2.jpg<?php echo '?t=' . rand() ?>" loading="lazy"></img>
					-->
					<a href="/manager-page/api/live.php?id=12" target="_blank">
					<img loading="lazy" style="width:100%;object-fit:fill;margin-top:14px;margin-bottom:14px;" data-src="/manager-page/api/snapshot.php?id=12" src="/manager-page/api/snapshot.php?id=12" onerror="this.src='live/1-2.jpg';" class="video_obj" />
					</a>
				</div>
			</div>
		...
		<div class="w3-card-4" style="margin-top:20px;width:100%;">
			...
			<div class="w3-container w3-border-left w3-border-right w3-border-bottom" >
                <div class="w3-half" style="">
                    <img style="width:100%;object-fit:fill;margin-top:14px;" src="alarm/1-1.jpg<?php echo '?t=' . rand() ?>" loading="lazy"></img>
                </div>
                <div class="w3-half" style="">
                    <img style="width:100%;object-fit:fill;margin-top:14px;margin-bottom:14px;" src="alarm/1-2.jpg<?php echo '?t=' . rand() ?>" loading="lazy"></img>
                </div>
			</div>
		</div>
...
<span id="cms_status_ui2">⚫</span>
	...
	<script>
		...
		$.get("api/cms-status1.php", function(data, status)
		{
			if (status == "success")
			{
		...
		$.get("api/lp-status1.php", function(data, status)
		{
			if (status == "success")
			{
				if (data == "1")
