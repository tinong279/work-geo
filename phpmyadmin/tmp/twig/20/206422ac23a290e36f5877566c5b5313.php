...
class __TwigTemplate_4e9190d8086a77f27ad0ba500b49fd88 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Your preferences will be saved for current session only. Storing them permanently requires %sphpMyAdmin configuration storage%s.");
    ...
    {
        return new Source("", "preferences/header.twig", "C:\\Apache24\\htdocs\\phpmyadmin\\templates\\preferences\\header.twig");
    }
}
