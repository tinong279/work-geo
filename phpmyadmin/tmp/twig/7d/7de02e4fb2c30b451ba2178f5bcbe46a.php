...
class __TwigTemplate_f0d9a73d9f583d9951e2e6d7a9f16509 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "C:\\Apache24\\htdocs\\default\\public_html\\phpmyadmin\\templates\\database\\export\\index.twig");
    }
}
